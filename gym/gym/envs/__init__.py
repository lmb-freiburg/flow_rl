...
register(
    id='Chaser2d-v2',
    entry_point='gym.envs.mujoco:Chaser2dEnv',
    max_episode_steps=250,
    reward_threshold=-1.,
    kwargs=dict(
        target_velocity=1.0,
        target_velocity_delta=0.0,
        add_high_res_output=False,
        no_movement=False,
        stack_frames=False,
        random_4_background=False,
        random_frequency=-1,  # -1 <=> change texture after each episode
        pre_state_dt=2   # 2 <=> stacked frame is from the previous state;
                         # 3 <=> stacked frame is from the state before the previous state
                         # etc
    )
)

register(
    id='ChaserWithRandom4Backgrounds2d-v2',
    entry_point='gym.envs.mujoco:Chaser2dEnv',
    max_episode_steps=250,
    reward_threshold=-1.,
    kwargs=dict(
...
register(
    id='Catcher2d-v2',
    entry_point='gym.envs.mujoco:Catcher2dEnv',
    max_episode_steps=250,
    reward_threshold=-1.,
    kwargs=dict(
        target_velocity=1.0,
...
register(
    id='HopperImg-v2',
    entry_point='gym.envs.mujoco:HopperImgEnv',
    max_episode_steps=1000,
    kwargs=dict(
        screen_output=True,
        vector_output=False,
...
register(
    id='SwimmerImg-v2',
    entry_point='gym.envs.mujoco:SwimmerImgEnv',
    max_episode_steps=1000,
    kwargs=dict(
        screen_output=True,
        vector_output=False,
...
register(
    id='Walker2dImg-v2',
    entry_point='gym.envs.mujoco:Walker2dImgEnv',
    max_episode_steps=1000,
    kwargs=dict(
        screen_output=True,
        vector_output=False,
...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='KeepUp3d{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:KeepUp3dEnv',
        max_episode_steps=250,
        kwargs={**kwargs, **dict(
            add_high_res_output=False,
            no_movement=False,
    ...
    register(
        id='KeepUpHighMotionPenalty3d{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:KeepUp3dEnv',
        max_episode_steps=250,
        kwargs={**kwargs, **dict(
            add_high_res_output=False,
